            ...
            return (
              <li key={opt.value} role="none" className="px-1">
                <button
                  ...
                  className={`filter-dd-option font-work-sans flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-sm font-medium tracking-[0.02em] transition ${
                    isSelected
