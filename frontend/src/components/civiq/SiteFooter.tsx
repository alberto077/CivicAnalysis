...
export function SiteFooter() {
  return (
    <footer className="relative z-10 mt-16 px-4 pb-5 sm:px-6 lg:px-8">
      <div className="surface-float mx-auto flex max-w-6xl flex-col gap-8 rounded-3xl border border-white/70 bg-[linear-gradient(160deg,rgba(255,255,255,0.72)_0%,rgba(255,255,255,0.5)_100%)] px-6 py-8 backdrop-blur-xl transition-colors duration-300 sm:flex-row sm:items-center sm:justify-between dark:border-[var(--border)] dark:bg-[linear-gradient(165deg,rgba(17,22,28,0.92)_0%,rgba(11,15,20,0.88)_100%)]">
